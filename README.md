...
#### Base URL
https://hideme.eu.org/developer/quranapi
#### Authentication
...
GET /quranapi?id={reciter_id}&chapter_number={chapter_number}
###### Parameters
...
###### Example
GET https://hideme.eu.org/developer/quranapi?id=3&chapter_number=36
#### Reciter IDs
